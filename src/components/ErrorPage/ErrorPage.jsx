  ...
  return (
    <div className='bg-black h-screen flex items-center justify-center'>
      ...
      {/* description section start */}
        <div>
          <p className='text-gray-400 md:text-5xl md:font-semibold'>Oops!</p>
          <p className='text-gray-400 md:text-3xl md:font-semibold md:my-3'>Sorry, an unexpected error has occurred.</p>
